                            ...
                            "opciones":[
                              {
                                "res":"no",
                                "texto":"Le falta sol",
                                "recomendacion":"Cambiarla a un lugar mas iluminado"
                              },
                              {
                                "res":"si",
                                "texto":"Le falta sol y humedad",
                                "recomendacion":"Cambiarla a un lugar mas iluminado y darle mas humedad con un humificador"
                              }
                            ]
                          },
                          {
                            ...
                            "opciones":[
                              {
                                ...
                                "recomendacion":"Cambiarla a un lugar iluminado, con luz y sin corrientes de aire"
                              },
                              {
                                "res":"no",
                                ...
                                "opciones":[
                                  {
                                    "res":"si",
                                    "texto":"Va a florear",
                                    "recomendacion":"No es malo, solo vera flores y quizá obtenga semillas"
                                  },
                                  {
                                    "res":"no",
                        ...
                        "opciones":[
                          {
                            "res":"si",
                            "texto":"Se congela",
                            "recomendacion":"Protegerla del frio y si algunas hojas ya estan aguadas cortalas"
                          },
                          {
                            "res":"no",
                                    ...
                                    "opciones":[
                                      {
                                        ...
                                        "recomendacion":"Verificar la calidad del agua y la frecuencia de riegos, que se mantenga humeda la tierra siempre pero sin encharcar",
                                      },
                                      {
                                        "res":"si",
...
void obtenerNuevoAcual(res){
  if(actual.containsKey('res')){
    ...
    if(actual['opciones'][0]['res'] == res) actual = actual['opciones'][0];
    else actual = actual['opciones'][1];
